...
#
#
# b <- run_singlegene_edgeR_integration(response_var = mirna_exp_model, covariates = tf_expression_model, design_mat_singlegene = a, offset_singlegene = offset, threads = 16)
