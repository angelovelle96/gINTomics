...
.gint_subItem_HeatmapGenomic  <- function(data_table){
  int_input_heatmap <- intersect(c("gene_genomic_res", "gene_met_res",
...
.gint_subItem_enrichGenomic <- function(data_table){
  ...
  dashboardPage(
    ...
    dashboardBody(
      tabItems(
        ...
        .gint_subItem_enrichGenomic(data_table),
