...
```{r}
gINTomics:::plot_venn(data_table)
...
```{r}
gINTomics:::plot_volcano(data_table, omics = "gene_genomic_res", cnv_met = "cnv")
gINTomics:::plot_volcano(data_table, omics = "gene_genomic_res", cnv_met = "met")
...
```{r}
gINTomics:::plot_ridge(data_table, omics = "gene_genomic_res", cnv_met = "cnv")
gINTomics:::plot_ridge(data_table, omics = "gene_genomic_res", cnv_met = "met")
...
```{r}
gINTomics:::plot_chr_distribution(data_table = data_table,
...
```{r}
gINTomics:::plot_tf_distribution(data_table = data_table)
